...
typedef struct Params{
	//////////////////////////////////////////////////////
	struct param_s params_sensorfusion6[6];
	//////////////////////////////////////////////////////
	/*************************************************************
	#ifdef MADWICK_QUATERNION_IMU
	struct param_s params_sensorfusion6[3];  //Sensfusion6.c 
	#else
	struct param_s params_sensorfusion6[4];
	#endif
	*************************************************************/
	struct param_s params_pid_attitude[11];  //Controller.c
	struct param_s params_pid_rate[11];  //  Controller.c
	struct param_s params_cpu[6];  //System.c
	struct param_s params_imu_acc_lpf[3];  //Imu.c
}paramsvar;
